/* ABIM Exam Simulator — Application Logic */

const ACCESS_CODE  = "ABIM9000";
const EXAM_SECONDS = 28800;
const PASSING_PCT  = 72;
const STORAGE_KEY  = "abim_exam_state_v1";
const SIM_Q_COUNT  = 240;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"allergy_and_immunology": "Allergy and Immunology", "cardiovascular_disease": "Cardiovascular Disease", "dermatology": "Dermatology", "endocrinology_diabetes_and_metabolism": "Endocrinology Diabetes and Metabolism", "gastroenterology": "Gastroenterology", "hematology": "Hematology", "infectious_disease": "Infectious Disease", "miscellaneous": "Miscellaneous", "nephrology_and_urology": "Nephrology and Urology", "neurology": "Neurology", "obstetrics_and_gynecology": "Obstetrics and Gynecology", "medical_oncology": "Medical Oncology", "ophthalmology": "Ophthalmology", "otolaryngology_and_dental_medicine": "Otolaryngology and Dental Medicine", "psychiatry": "Psychiatry", "pulmonary_disease": "Pulmonary Disease", "rheumatology_and_orthopedics": "Rheumatology and Orthopedics", "geriatric_syndromes": "Geriatric Syndromes"};  // maps domain key -> human-readable label for display
